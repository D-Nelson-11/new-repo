          ...
          className="border border-1 p-2 rounded">
            ...
            <Row>
                <Col>
                   ...
                   <Col>
                      <Form.Label>Catgoría</Form.Label>
            ...
            <Col>
              ...
              <option value="">Selecciona</option>
                  ...
                  <option value="afa84692-8f97-43a6-8651-19236a7d1bf7">Bolsa</option>
                  ...
                  <option value="da934b3c-50f6-40b6-8b67-24b2c757f3bc">Flexitanque</option>
              </Form.Select>
            </Col>
            <Col>
              <Form.Label>ProveedorId</Form.Label>
               <Form.Control type="text" {...register("ProveedorId", { required: true })} placeholder="ProveedorId"/>
            </Col>
          </Row>
            <Row>
                <Col>
                    <Form.Label style={{display:"block"}}>Descripciones</Form.Label>
                    <textarea name="descripciones" id="" style={{width:"100%", height:"100px"}}></textarea>
                </Col>
                  <Col>
                    <Form.Label style={{display:"block"}}>Códigos</Form.Label>
                    <textarea name="Codigos" id="" style={{width:"100%", height:"100px"}}></textarea>
                </Col>
            </Row>
